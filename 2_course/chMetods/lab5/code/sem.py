...
dt_sample_sinc1 = 0.2  # Нарушение Найквиста
dt_sample_sinc2 = 0.01  # Соблюдение Найквиста
...
plt.xlim([-1, 1])
plt.grid(True, alpha=0.3)
plt.legend(['$y_2(t)$', 'Sampling $y_2(t)$'])
plt.axhline(y=0.0, color='black', linestyle='-', linewidth=1, alpha=0.7)
...
plt.xlim([-1, 1])
plt.grid(True, alpha=0.3)
plt.legend(['$y_2(t)$', 'Interpolation $y_1(t)$'])
...
plt.xlim([-12, 12])
plt.grid(True, alpha=0.3)
plt.legend(['$y_1(t)$', 'Restored. ($\\Delta t = \\frac{1}{5}$)', 'Restored. ($\\Delta t = \\frac{1}{100}$)'])
...
plt.xlim([-12, 12])
plt.grid(True, alpha=0.3)
plt.legend(['$y_1(y)$', 'Restored. ($\\Delta t = \\frac{1}{5}$)', 'Restored. ($\\Delta t = \\frac{1}{100}$)'])
