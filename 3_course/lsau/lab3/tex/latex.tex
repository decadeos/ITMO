...
\begin{document}
	...
	\begin{table}[H]
		...
		\begin{tabular}{@{}clccc@{}}
			...
			\midrule
			1 & 5.8 & 57.41 & \(-1, 0\);\quad \(0, 0\);\quad \(1, 0\) & \(0.5\) \\
			2 & 0 & 361 & \(-1, 0\);\quad \(0, 0\);\quad \(1, 0\) & \(0.8 t\) \\
			3 & -1.8 & 49.81 & \(-1, 0\);\quad \(0, 0\);\quad \(1, 0\) & \(\cos(2t)\) \\
			\bottomrule
		\end{tabular}
	\end{table}
	...
	Построю структурную схему систему -- возьму за основу схему из Лабораторной работы №2 (задание 1) и дострою вход \(u(t)\) с помощью блока \texttt{From Workspace}.
