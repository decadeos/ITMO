print(['-s' gcs], '-dpng', '-r300', '../../images/task4/model41.png');
...
xlim([-0.01, 60.5]); %ylim([-0.1, 6.5]);
grid on; grid minor; box on; grid on;
grid on; grid minor; box on;

set(findall(gcf, '-property', 'FontName'), 'FontName', 'DejaVu Math TeX Gyre');
exportgraphics(gcf, '../../images/task4/y1.png', 'Resolution', 300);
...
set(findall(gcf, '-property', 'FontName'), 'FontName', 'DejaVu Math TeX Gyre');
exportgraphics(gcf, '../../images/task4/e1.png', 'Resolution', 300);