...
xlabel('$T_1$', 'FontSize', 15, 'FontWeight', 'normal', 'Interpreter', 'latex');
ylabel('$K$', 'FontSize', 15, 'FontWeight', 'normal', 'Interpreter', 'latex');

legend({'$K(T_1)$ при фиксированном $T_2$', '$K=12.5$'}, 'Interpreter', 'latex', 'Location', 'northeast', 'FontSize', 15);

box on;

% Сохраняем
exportgraphics(gcf, '../../images/task2/T1.png', 'Resolution', 300);
