...
% 
% xl = xlim; xlim([xl(1)-0.2 xl(2)-0.2])
...
% exportgraphics(gcf,'../../../images/task2/o1/GNA.png','Resolution',300)
% exportgraphics(gcf,'../../../images/task2/o1/GNA.pdf','ContentType','vector')
...
xl = xlim; xlim([xl(1)-0.07 xl(2)-0.07])
ax = gca; ax.LineWidth = 1.5; ax.FontSize = 13;
ax.XColor = [0.3, 0.3, 0.3]; ax.YColor = [0.3, 0.3, 0.3]; box on;
ax.GridColor = [0.9, 0.9, 0.9]; ax.GridAlpha = 0.4; 
ax.MinorGridColor = [0.95, 0.95, 0.95];ax.MinorGridAlpha = 0.1;
...
set(findall(gcf, '-property', 'FontName'), 'FontName', 'DejaVu Math TeX Gyre');
exportgraphics(gcf,'../../../images/task2/o1/GNA4.png','Resolution',300)
exportgraphics(gcf,'../../../images/task2/o1/GNA4.pdf','ContentType','vector')