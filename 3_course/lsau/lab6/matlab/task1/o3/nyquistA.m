num = [16 154 428 374 372]; 
den = conv(conv(conv([1 -1],[1 -2]),[1 -3]), conv([1 4],[1 5]));
W = tf(num, den);
w = logspace(-2, 3, 5000);
...
set(h,'LineWidth',3,'Color',[0, 0.5, 0.4])
...
exportgraphics(gcf,'../../../images/task1/o3/GNA.png','Resolution',300)
exportgraphics(gcf,'../../../images/task1/o3/GNA.pdf','ContentType','vector')