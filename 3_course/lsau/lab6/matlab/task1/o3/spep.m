...
% xl = xlim; xlim([-0.01 xl(2)-0.7])
% yl = ylim; ylim([yl(1)-0.1*10^26 yl(2)-10^26])
% 
% 
% set(findall(gcf, '-property', 'FontName'), 'FontName', 'DejaVu Math TeX Gyre');
% exportgraphics(gcf,'../../../images/task1/o3/h-raz.png','Resolution',300)
% exportgraphics(gcf,'../../../images/task1/o3/h-raz.pdf','ContentType','vector')
...
ylabel('Amplitude', 'FontSize', 13, 'FontWeight', 'normal');
legend('$y_{s.r.}(t)$', 'Interpreter','latex', 'Location','northwest', 'FontSize', 15);
xl = xlim; xlim([xl(1)-0.02, xl(2)-1])
yl = ylim; ylim([-0.1, 1.56])

set(findall(gcf, '-property', 'FontName'), 'FontName', 'DejaVu Math TeX Gyre');
exportgraphics(gcf,'../../../images/task1/o3/h-zamk.png','Resolution',300)
exportgraphics(gcf,'../../../images/task1/o3/h-zamk.pdf','ContentType','vector')