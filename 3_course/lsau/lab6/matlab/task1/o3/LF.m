...
xline(15.4655,'Color',[0.3 0.3 0.3],'LineWidth',1)
...
exportgraphics(gcf,'../../../images/task1/o3/lach.png','Resolution',300)
exportgraphics(gcf,'../../../images/task1/o3/lach.pdf','ContentType','vector')
...
set(findall(gcf, '-property', 'FontName'), 'FontName', 'DejaVu Math TeX Gyre');
exportgraphics(gcf,'../../../images/task1/o3/lfch.png','Resolution',300)
exportgraphics(gcf,'../../../images/task1/o3/lfch.pdf','ContentType','vector')