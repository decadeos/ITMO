...
xline(6.3095,'Color',[0.3 0.3 0.3],'LineWidth',1)
...
exportgraphics(gcf,'../../../images/task1/o2/lach.png','Resolution',300)
exportgraphics(gcf,'../../../images/task1/o2/lach.pdf','ContentType','vector')
...
set(findall(gcf, '-property', 'FontName'), 'FontName', 'DejaVu Math TeX Gyre');
exportgraphics(gcf,'../../../images/task1/o2/lfch.png','Resolution',300)
exportgraphics(gcf,'../../../images/task1/o2/lfch.pdf','ContentType','vector')