...
\begin{document}
	...
	\begin{titlepage}
		...
		{\small
			...
			Федеральное государственное автономное образ			овательное учреждение\\
			высшего образования\\
	...
	\begin{cases}
		a = 0 & \omega < T^{-1} \\
		a = 1 & \omega > T^{-1}
	\end{cases} хема операционного усилителя
