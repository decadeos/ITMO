...
folder = '../../report/images/task3';

% Моделирование

simOut = sim('closed_observer.slx', 'StopTime', '5');
t = simOut.x.time;
...
filename = fullfile(folder, sprintf('e.png'));
saveas(e_fig, filename); close(e_fig);
...
filename = fullfile(folder, sprintf('x.png'));
...
plot(t, u(:,1), 'Color', colors(2,:), 'LineWidth', line_width, 'DisplayName', '$u(t)$');
