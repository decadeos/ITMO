...
exportgraphics(fig_y, '../../report/images/task3/y_ex.pdf', 'ContentType', 'vector');
close(fig_y);
...
setPlotStyle(gca, 'FontSize', F_g, 'LineWidth', L_g);
xlim([-0.02; 10.02]); ylim([limYDown*1.4; limYUp*1.6]);
...
exportgraphics(fig_e, '../../report/images/task3/e_ex.pdf', 'ContentType', 'vector');
close(fig_e);
...
setPlotStyle(gca, 'FontSize', F_g, 'LineWidth', L_g);
xlim([-0.02; 10.02]); ylim([limYDown*1.3; limYUp*2.2]);
...
exportgraphics(fig_u, '../../report/images/task3/u_ex.pdf', 'ContentType', 'vector');
close(fig_u);
...
exportgraphics(fig_x, '../../report/images/task3/x_ex.pdf', 'ContentType', 'vector');
close(fig_x);
