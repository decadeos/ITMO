...
% end
% exportgraphics(gcf,'../../report/images/task2/x3.pdf','ContentType','vector')
...
%     set(findall(gcf,'-property','FontName'),'FontName','DejaVu Math TeX Gyre');
% end
% exportgraphics(gcf,'../../report/images/task2/e3.pdf','ContentType','vector')
...
exportgraphics(gcf,'../../report/images/task2/xp3.pdf','ContentType','vector')