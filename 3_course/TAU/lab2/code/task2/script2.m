...
%         'Interpreter','latex','Location','southeast','FontSize',Le, 'NumColumns', 2)
%     xlim([-0.05 4.01]); ylim([-300; 30]);
%     if i == 4
%         xlabel('$t$','Interpreter','latex','FontSize',M)
%     end
%     set(findall(gcf,'-property','FontName'),'FontName','DejaVu Math TeX Gyre');
% end
% exportgraphics(gcf,'../../report/images/task2/x2.pdf','ContentType','vector')
% 
...
%         'Interpreter','latex','Location','southeast','FontSize',Le)
%     xlim([-0.05 4.01]); 
%     ylim([-2000; 500]);
%     if i == 4
%         xlabel('$t$','Interpreter','latex','FontSize',M)
...
%     set(findall(gcf,'-property','FontName'),'FontName','DejaVu Math TeX Gyre');
% end
% exportgraphics(gcf,'../../report/images/task2/e2.pdf','ContentType','vector')
...
%     set(findall(gcf,'-property','FontName'),'FontName','DejaVu Math TeX Gyre');
% end
% exportgraphics(gcf,'../../report/images/task2/xp2.pdf','ContentType','vector')