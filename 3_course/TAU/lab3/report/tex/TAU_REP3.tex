...
\begin{document}
	...
	\newpage \section{Синтез регулятора с заданной степенью устойчивости}
...
\end{figure}
	...
	\[
	\sigma(A + BK_2) = \{-0.49 \pm 3.2\mathrm{j},\; -3\}
	\]
...
\end{figure}
	...
	\subsection{Синтез регулятора \(K_1\)}
	...
	\subsection{Синтез наблюдателя $L_1$}
